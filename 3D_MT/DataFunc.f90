...
module dataFunc
  ...
  !Z(6)->Z(10)                                                WangPeijie 2020.12.03    
  complex(kind=prec),save, private	:: Z(10)
...
!******************************************************************************
  ...
  !   iDT=EM_Fields
  !  			Z(1) = E-Pol Ex , Z(2) =  E-Pol Ey, Z(3) =  E-Pol Hx, Z(4) =  E-Pol Hy	, Z(5) =  E-Pol Hz		
  !  			Z(6) = B-Pol Ex , Z(7) =  B-Pol Ey, Z(8) =  B-Pol Hx, Z(9) =  B-Pol Hy	, Z(10) =  B-Pol Hz
 ...
 selectcase (iDT)
     ...
     case(Full_Interstation_TF)
    	   ...
    	   case(Off_Diagonal_Rho_Phase)
             ...
             ! Z(2)  = atan2(TimeFactorMultiplier*dimag(tempZ(1)),real(tempZ(1)))
             ...
             ! Z(4)  = atan2(TimeFactorMultiplier*dimag(tempZ(2)),real(tempZ(2)))
             ! remove PI, Liuzhongyin 2017.06.04
               Z(4)  = atan2(ISIGN*dimag(tempZ(2)),real(tempZ(2)))
             ! Z(4)  = atan2(ISIGN*dimag(tempZ(2)),real(tempZ(2)))+PI
...
if (typeDict(iDT)%tfType .eq. Off_Diagonal_Rho_Phase) then
       do k=1,2 ! 2 modes
        ...
        ! remove R2D, Liuzhongyin 2017.06.04          
